...
def copy_specified_index():
    ...
    try:
        ...
        if specified_index < 1:
            raise ValueError("指定された番目は1以上の整数である必要があります。")
...
# 新しい「コピー貼り付け」ボタンを追加
copy_paste_button = ctk.CTkButton(window, text="コピー貼り付け", command=lambda: subprocess.Popen(['python', 'ctkmain0603_02.py']), fg_color="#0078D7", text_color="white", hover_color="#0053A6")
copy_paste_button.pack(pady=10)
